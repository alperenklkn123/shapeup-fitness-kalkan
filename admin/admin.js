(function () {
  ...
  const TEXT_FIELDS = [
    ...
    { key: "heroLine1", label: "Kapak başlığı — 1. satır", rows: 1 },
    { key: "heroLine2", label: "Kapak başlığı — 2. satır", rows: 1 },
    { key: "heroCopy", label: "Kapak açıklaması", rows: 3 },
    { key: "plansCta", label: "Üyelik düğmesi", rows: 1 },
